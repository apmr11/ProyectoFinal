...
#               PERSONAJE 1
    ...
    def p1_lou1(self):
        ...
        if eleccion == 'ignorar':
            ...
            print("\nLuego de toda la platica y la firma. Intentas volver con el tour pero ya no estan. Desaparecieron.Entonces regresas con la local a que te ayude a llegar a la embajada")     
           #ARREGLAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAR
        else:
